						...
						<tbody>
							{orders.map(order => (
									...
									<tr key={order._id} >
										...
										<td>
											{
												order.isFinanceApproved === true ? <Button variant='success' className='btn-sm' disabled>Approved</Button>
												: order.isFinanceApproved === false ? <Button variant='danger' className='btn-sm' disabled>Rejected</Button>
										...
										<td>
											...
											<LinkContainer to={`/order/approved/${order._id}`}>
...
export default ApprovedPurchaseOrderList